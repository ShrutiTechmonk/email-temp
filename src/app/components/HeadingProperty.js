...
function HeadingProperty({ showContents, content }) {
  return (
    <div
    ...
    >
      <div className="flex gap-5 border-b pb-5" onClick={() => showContents()}>
        <img
          ...
          height={17}
        />
        <label className="text-xl font-semibold">Heading Property</label>
      </div>
      <div className="flex flex-col gap-5">
      <div className="flex items-center border-b py-5">
          <label className="text-base font-medium w-[60%]">Heading Type</label>
...
export default HeadingProperty
